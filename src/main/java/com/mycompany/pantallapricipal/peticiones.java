...
public class peticiones {
    ...
    public static double traerpeso(double peso) {
    
    Connection conn = DB.conectar();

    if (conn != null) {
        
        String query = "SELECT * FROM usuario WHERE nombre = ? AND correo AND contrasena AND  edad AND  peso AND  sexo AND  alturapeso = ? ";
